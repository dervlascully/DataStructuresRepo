...
public abstract class AbstractHashMap<K, V> extends AbstractMap<K, V> {
    ...
    public AbstractHashMap(int cap, int p) {
        ...
        createTable(); // initialises the bucket table
    }
     ...
     * Every object in java has a hash code. The key of type K is an object, we get its hash code using k.hashCode()
     * This value is unique for this key
     * We then apply a scale and shift
     * Modulo of prime factor
     * Compress into capacity of table - modulo of capacity
     * Cast to int
     */
