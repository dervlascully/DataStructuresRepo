...
// N should be Entry type
public class BinaryTreePrinter< N extends Comparable<N>> {

    private boolean squareBranches = true; // different branch types when set to true or false, can choose either
